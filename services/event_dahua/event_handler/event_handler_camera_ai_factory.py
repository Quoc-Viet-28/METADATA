...
class EventHandlerCameraAIFactory:
    class_registry = {}
    ...
    def auto_import_classes(cls, package_name):
        ...
        for _, module_name, _ in pkgutil.iter_modules([package_dir]):
            importlib.import_module(
                f"app.services.event_dahua.event_handler.{package_name}.{module_name}")


EventHandlerCameraAIFactory.auto_import_classes("classes_camera_ai")
